                ...
                <table class="table table-sm table-striped table-hover table-bordered">
                    ...
                    <tbody>
                        <tr v-for="cli in clientes" :key="cli.idcliente">
                            ...
                            <td v-text="cli.especialidad" class="ui-max-w-300 text-truncate"></td>
                            <td v-text="cli.pais" class="ui-max-w-300 text-truncate"></td>
                            <td v-text="cli.evento" class="ui-max-w-300 text-truncate"></td>
                            <td v-text="cli.tipoparticipante" class="ui-max-w-300 text-truncate"></td>
                            <td v-text="cli.ocupacion" class="ui-max-w-300 text-truncate"></td>
