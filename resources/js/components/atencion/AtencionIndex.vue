            ...
            <template v-slot:card-body-main>
                <div class="form-row mb-2">
                    ...
                    <div class="form-group col-12 col-sm-6 col-md-4 col-xl-3">
                        ...
                        <select2 :options="campanias" @input="buscarCliente()" v-model="cliente.idcampania"
                    ...
                    <div class="form-group col-12 col-sm-6 col-md-4 col-xl-3">
                        ...
                        <select2 :options="distritos" @input="buscarCliente()" v-model="cliente.coddistrito"
                    ...
                    <table class="table table-sm table-striped table-hover table-bordered">
                        <thead>
                            <tr>
                                ...
                                <th class="p-2 text-nowrap">F. Atentcion</th>
                            ...
                            <tr v-for="cli in clientes" :key="cli.idcliente">
                                ...
                                <td >
                                    <span class="badge badge-pill" 
                                        :class="cli.ultimaatencion.tipoatencion.color"
                                        v-text="cli.ultimaatencion.tipoatencion.tipoatencion">
                                    </span>
                                </td>
                                ...
                                <td v-text="cli.ultimaatencion.fecha" class="ui-max-w-100 text-truncate"></td>
                                <td v-text="cli.ultimaatencion.comentario" class="ui-max-w-200 text-truncate"></td>
                                <td>
                                    <span class="badge badge-pill py-1 px-3"
    ...
    export default {
        ...
        methods: {
            ...
            addFiltersRole() {
                ...
                if (this.cliente.idtipoatencion)
